...
|---|---|---|---|---|---|---|
| Novel-tile-kind alert (operator asked "what are Will's chars standing on?" during a bunker — any tile kind outside the known vocabulary fires the wake-up channel + codex note; new-content detection) | 0.72 | 1.00 | 0 | — | 0.540 | just added (tc=0) |
